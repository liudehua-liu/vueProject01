<template>
  <div id="app">
    ...
    <input type="text" v-model="inp1" placeholder="请输入兑换码" class="inp1" @input="inp1_length">
    <div class="lpl">
      <input type="text" v-model="inp2" placeholder="验证码" class="inp2" maxlength="4" @input="inp1_length">
    ...
    <button :class="temp?'change':'change2'" @click="duihuan">兑换</button>
...
<script>
  export default {
    ...
    methods: {
      ...
      inp1_length() {
        if (this.inp1 != "" && this.inp2.length == 4) {
          this.temp = !this.temp
        }
      },
      duihuan() {
